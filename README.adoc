...
----
(debian)$ sudo apt-get install git screen ruby-all-dev libaspell-dev perl liblua5.2-dev libv8-dev tcl-dev libncurses5-dev libncursesw5-dev python-dev guile-2.0-dev libgcrypt-dev cmake libcurl4-gnutls-dev gnutls-dev libperl-dev
$ mkdir build
$ cd build
...
Copyright (c) 2016 Andrew Lee <rasengan@serv.ninja>
